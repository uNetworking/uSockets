...
WIN32_EXPORT struct us_timer *us_create_timer(struct us_loop_t *loop, int fallthrough, unsigned int ext_size);
...
WIN32_EXPORT struct us_loop_t *us_timer_loop(struct us_timer *t);
