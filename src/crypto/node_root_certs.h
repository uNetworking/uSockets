...
//
// `src/crypto/node_root_certs.h` contains a compiled-in set of root certificates used as trust anchors
...
// in `src/crypto/node_root_certs.h`.
//
// When to update
//
