...
// put this in loop.c?
struct us_socket_context *us_create_socket_context(struct us_loop_t *loop, int context_ext_size) {
...
struct us_loop_t *us_socket_context_loop(struct us_socket_context *context) {
    return context->loop;
}
